...
static potion_type _gozag_potion_list[][4] =
{
    ...
    { POT_RESISTANCE, POT_CURING, NUM_POTIONS, NUM_POTIONS },
    ...
    { POT_MIGHT, POT_CURING, POT_BRILLIANCE, NUM_POTIONS },
    { POT_HASTE, POT_CURING, POT_FLIGHT, NUM_POTIONS },
    ...
    { POT_RESISTANCE, POT_INVISIBILITY, POT_CURING, NUM_POTIONS },
};
