...
public:
    UINewGameMenu(int _choice_type, newgame_def& _ng, newgame_def& _ng_choice, const newgame_def& _defaults) : m_choice_type(_choice_type), m_ng(_ng), m_ng_choice(_ng_choice), m_defaults(_defaults)
    {
        ...
        hp->set_margin_for_crt(0, 1, 0, 0);
        auto hp_str = make_shared<Text>(formatted_string("HP:", LIGHTBLUE));
        hp_str->set_margin_for_crt(0, 1, 0, 0);
        hp->add_child(hp_str);
        ...
        mp->set_margin_for_crt(0, 1, 0, 0);
        auto mp_str = make_shared<Text>(formatted_string("MP:", LIGHTBLUE));
        mp_str->set_margin_for_crt(0, 1, 0, 0);
        mp->add_child(mp_str);
        ...
        mr->set_margin_for_crt(0, 1, 0, 0);
        auto mr_str = make_shared<Text>(formatted_string("MR (/XL):", LIGHTBLUE));
        mr_str->set_margin_for_crt(0, 1, 0, 0);
        mr->add_child(mr_str);
