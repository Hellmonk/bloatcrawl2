...
static job_group jobs_order[] =
{
    ...
    },
    {
        ...
        coord_def(2, 0), 15,
        {
            ...
            JOB_ABYSSAL_KNIGHT, JOB_BERSERKER, JOB_DANCER,  JOB_CHAOS_KNIGHT,
            JOB_BLOOD_KNIGHT, JOB_GAMBLER, JOB_WARRIOR, /* P god, */
            JOB_STORM_CLERIC, JOB_HERMIT, JOB_LIBRARIAN, JOB_BERSERKER,
            JOB_DANCER, JOB_ANNIHILATOR, JOB_DISCIPLE, JOB_CHAOS_KNIGHT,
            JOB_DEATH_BISHOP, JOB_ZINJA,
        }
    },
};
