...
{ SP_BARACHI, {
    ...
    { SK_WHIPS_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_MACES_STAVES,
...
{ SP_DEEP_DWARF, {
    ...
    { SK_WHIPS_FLAILS, SK_AXES, SK_LONG_BLADES, SK_CROSSBOWS, SK_SLINGS },
} },
...
{ SP_DEEP_ELF, {
    ...
    { SK_SHORT_BLADES, SK_MACES_STAVES, SK_BOWS },
} },
...
{ SP_SILENT_SPECTRE,{
	...
	{ MUT_UNBREATHING_FORM, 1, 1 }, {MUT_SILENT_CAST, 1, 1}, {MUT_GHOST,1,1}, },
	...
	{ SK_WHIPS_FLAILS, SK_SHORT_BLADES, SK_POLEARMS, SK_LONG_BLADES, SK_MACES_STAVES,
	SK_THROWING },
} },
...
{ SP_GOBLIN,{
	...
	{ {MUT_LOW_MAGIC, 1, 1} , {MUT_GODS_PITY, 2, 1} , {MUT_MUTATION_RESISTANCE, 1,1}},
	...
	{ SK_WHIPS_FLAILS, SK_POLEARMS, SK_LONG_BLADES, SK_MACES_STAVES,
...
{ SP_FELID, {
    ...
    { JOB_BERSERKER, JOB_ENCHANTER, JOB_TRANSMUTER, JOB_ICE_ELEMENTALIST,
      JOB_SUMMONER, JOB_AIR_ELEMENTALIST, JOB_VENOM_MAGE },
    { SK_UNARMED_COMBAT },
} },
...
{ SP_FORMICID, {
    ...
    { STAT_STR, STAT_INT }, 4,
    { { MUT_ANTENNAE, 3, 1 }, },
    { "You cannot be hasted, slowed, berserked, petrified or teleported.",
...
{ SP_GARGOYLE, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_BERSERKER,
      ...
      JOB_VENOM_MAGE },
    { SK_WHIPS_FLAILS, SK_MACES_STAVES, SK_BOWS, SK_CROSSBOWS },
} },
...
{ SP_HILL_ORC, {
    ...
    { SK_WHIPS_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES },
} },
...
{ SP_KOBOLD, {
    ...
    { JOB_HUNTER, JOB_BERSERKER, JOB_ARCANE_MARKSMAN, JOB_ENCHANTER,
      JOB_SUMMONER },
    { SK_SHORT_BLADES, SK_WHIPS_FLAILS, SK_MACES_STAVES, SK_CROSSBOWS,
	  SK_SLINGS, },
} },
...
{ SP_LIGNIFITE,{
	...
	{ SK_WHIPS_FLAILS, SK_POLEARMS, SK_MACES_STAVES,
	  SK_THROWING },
} },
...
{ SP_NAGA, {
    ...
    { { MUT_ACUTE_VISION, 1, 1 }, { MUT_SLOW, 2, 1 },  { MUT_DEFORMED, 1, 1 },
      ...
      { MUT_SLOW_METABOLISM, 1, 1 }, { MUT_CONSTRICTING_TAIL, 1, 1 } },
    ...
    { SK_MACES_STAVES, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_BOWS,
      SK_CROSSBOWS, SK_SLINGS },
} },
...
{ SP_OGRE, {
    ...
    { SK_MACES_STAVES, SK_POLEARMS, SK_MACES_STAVES, SK_AXES },
} },
...
{ SP_TROLL, {
    ...
    { SK_UNARMED_COMBAT, SK_WHIPS_FLAILS },
} },
...
{ SP_HIGH_ELF, {
    ...
    {},
    {},
    { JOB_HUNTER, JOB_SKALD, JOB_WIZARD, JOB_FIRE_ELEMENTALIST,
      JOB_ICE_ELEMENTALIST, JOB_AIR_ELEMENTALIST },
    { SK_SHORT_BLADES, SK_LONG_BLADES, SK_MACES_STAVES, SK_BOWS },
} },
#endif
