...
{ SP_CAVE_TROLL, {
        ...
        { STAT_STR }, 3,
        { { MUT_TOUGH_SKIN, 2, 1 },
          { MUT_FAST_HEALTH_REGENERATION, 2, 1 },
          { MUT_STAMINA_FROM_CORPSES, 1, 1 },
          { MUT_CLAWS, 3, 1 },
          { MUT_FAST_METABOLISM, 1, 1 },
          { MUT_SHAGGY_FUR, 1, 1 },
          { MUT_SHAGGY_FUR, 1, 6 },
          { MUT_STAMINA_FROM_CORPSES, 1, 8 },
          { MUT_SHAGGY_FUR, 1, 12 },
          { MUT_STAMINA_FROM_CORPSES, 1, 16 },
        },
        {},
        {},
        { JOB_FIGHTER, JOB_MONK, JOB_HUNTER, JOB_BERSERKER, JOB_WARPER,
          JOB_EARTH_ELEMENTALIST, JOB_WIZARD }, // test comment
...
{ SP_HALFLING, {
    ...
    {},
    {},
    { JOB_FIGHTER, JOB_HUNTER, JOB_ASSASSIN, JOB_BERSERKER, JOB_ENCHANTER, JOB_CONJURER,
      JOB_FIRE_ELEMENTALIST, JOB_ICE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_AIR_ELEMENTALIST },
...
{ SP_LAVA_ORC, {
    ...
    { JOB_FIGHTER, JOB_MONK, JOB_BERSERKER, JOB_ABYSSAL_KNIGHT, JOB_TRANSMUTER,
      JOB_SKALD, JOB_EARTH_ELEMENTALIST, JOB_NECROMANCER, JOB_FIRE_ELEMENTALIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_UNARMED_COMBAT },
} },
...
{ SP_MOON_TROLL, {
    ...
    { { MUT_TOUGH_SKIN, 2, 1 },
      { MUT_FAST_HEALTH_REGENERATION, 2, 1 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 1 },
      { MUT_CLAWS, 2, 1 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 4 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 8 },
      { MUT_SHAGGY_FUR, 1, 10 },
      { MUT_SHAGGY_FUR, 1, 12 },
...
{ SP_MUMMY, {
    ...
    { STAT_STR, STAT_INT, STAT_DEX }, 5,
    { { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 },
      { MUT_FAST_STAMINA_REGENERATION, 1, 1 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 1 },
      { MUT_COLD_RESISTANCE, 1, 1 },
      { MUT_TORMENT_RESISTANCE, 1, 1 },
      { MUT_UNBREATHING, 1, 1 },
      { MUT_FAST_STAMINA_REGENERATION, 1, 6 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 6 },
      { MUT_NECRO_ENHANCER, 1, 10 },
      { MUT_FAST_STAMINA_REGENERATION, 1, 12 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 12 },
      { MUT_NECRO_ENHANCER, 1, 20 },
...
{ SP_VINE_STALKER, {
    ...
    { STAT_STR, STAT_DEX }, 4,
    {
      { MUT_FAST_HEALTH_REGENERATION, 1, 1 },
	  { MUT_FANGS, 2, 1 },
      { MUT_MAGIC_SHIELD, 1, 1 },
      { MUT_ANTIMAGIC_BITE, 1, 1 },
      { MUT_NO_DEVICE_HEAL, 3, 1 },
      { MUT_ROT_IMMUNITY, 1, 1 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 4 },
      { MUT_FANGS, 1, 6 },
      { MUT_FAST_HEALTH_REGENERATION, 1, 6 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 8 },
      { MUT_MAGIC_SHIELD, 1, 9 },
      { MUT_FAST_HEALTH_REGENERATION, 1, 12 },
      { MUT_FAST_MAGIC_REGENERATION, 1, 15 },
      { MUT_MAGIC_SHIELD, 1, 18 },
    },
...
{ SP_UNKNOWN, { // Line 1: enum
    ...
    0, 0, 0, 0, // Line 5: XP, HP, SP, MP (gen-apt.pl needs them here!)
