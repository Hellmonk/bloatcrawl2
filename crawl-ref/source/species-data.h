...
{ SP_MOON_TROLL, {
    ...
    { { MUT_TOUGH_SKIN, 2, 1 },
      { MUT_HEALTH_REGENERATION, 2, 1 },
      { MUT_MAGIC_REGENERATION, 1, 1 },
      { MUT_CLAWS, 2, 1 },
      { MUT_MAGIC_REGENERATION, 1, 4 },
      { MUT_MAGIC_REGENERATION, 1, 8 },
      { MUT_SHAGGY_FUR, 1, 10 },
      { MUT_SHAGGY_FUR, 1, 12 },
...
{ SP_MUMMY, {
    ...
    { STAT_STR, STAT_INT, STAT_DEX }, 5,
    { { MUT_NEGATIVE_ENERGY_RESISTANCE, 3, 1 },
      { MUT_STAMINA_REGENERATION, 1, 1 },
      { MUT_MAGIC_REGENERATION, 1, 1 },
      { MUT_COLD_RESISTANCE, 1, 1 },
      { MUT_TORMENT_RESISTANCE, 1, 1 },
      { MUT_UNBREATHING, 1, 1 },
      { MUT_STAMINA_REGENERATION, 1, 6 },
      { MUT_MAGIC_REGENERATION, 1, 6 },
      { MUT_NECRO_ENHANCER, 1, 10 },
      { MUT_STAMINA_REGENERATION, 1, 12 },
      { MUT_MAGIC_REGENERATION, 1, 12 },
...
{ SP_VINE_STALKER, {
    ...
    { STAT_STR, STAT_DEX }, 4,
    {
      ...
      { MUT_MAGIC_REGENERATION, 1, 4 },
      { MUT_FANGS, 1, 6 },
      { MUT_HEALTH_REGENERATION, 1, 6 },
      { MUT_MAGIC_REGENERATION, 1, 8 },
      { MUT_MAGIC_SHIELD, 1, 9 },
      { MUT_HEALTH_REGENERATION, 1, 12 },
      { MUT_MAGIC_REGENERATION, 1, 15 },
