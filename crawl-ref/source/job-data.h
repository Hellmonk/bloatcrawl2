enum weapon_choice
{
    ...
    WCHOICE_POVERTY,///< Choice of "penniless traveler or beggar" weapons
};
...
{ JOB_ABYSSAL_KNIGHT, {
    "AK", "Abyssal Knight",
    4, 4, 4,
    { SP_HILL_ORC, SP_SPRIGGAN, SP_CAVE_TROLL, SP_MERFOLK, SP_BASE_DRACONIAN,
      SP_DEMONSPAWN, },
    { "leather armour" },
    WCHOICE_GOOD,
    { { SK_FIGHTING, 4 }, { SK_ARMOUR, 2 }, { SK_DODGING, 1 },
      { SK_INVOCATIONS, 2 }, { SK_WEAPON, 3 }, { SK_STEALTH, 1 }, },
} },
...
{ JOB_ARTIFICER, {
    ...
    { { SK_EVOCATIONS, 4 }, { SK_DODGING, 2 }, { SK_FIGHTING, 2 },
      { SK_WEAPON, 2 }, { SK_STEALTH, 2 }, },
} },

{ JOB_ASSASSIN, {
    "As", "Assassin",
    3, 3, 6,
    { SP_CAVE_TROLL, SP_HALFLING, SP_SPRIGGAN, SP_DEMONSPAWN, SP_VAMPIRE,
      SP_VINE_STALKER, },
    { "dagger plus:2", "blowgun plus:1", "robe", "cloak", "needle ego:curare q:20" },
    WCHOICE_NONE,
    { { SK_FIGHTING, 3 }, { SK_DODGING, 1 }, { SK_STEALTH, 4 },
      { SK_THROWING, 2 }, { SK_WEAPON, 3 }, },
} },
...
{ JOB_BERSERKER, {
    ...
    { "animal skin" },
    WCHOICE_PLAIN,
    { { SK_FIGHTING, 4 }, { SK_DODGING, 2 }, { SK_WEAPON, 4 }, },
} },
...
{ JOB_EARTH_ELEMENTALIST, {
    ...
    { "robe", "stone q:50", "book of Geomancy" },
    WCHOICE_NONE,
...
{ JOB_ENCHANTER, {
    ...
    WCHOICE_NONE,
    { { SK_WEAPON, 2 }, { SK_HEXES, 3 }, { SK_SPELLCASTING, 3 },
...
{ JOB_FIGHTER, {
    "Fi", "Fighter",
    8, 0, 4,
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_CAVE_TROLL, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, },
    { "scale mail", "shield", "potion of might" },
    WCHOICE_GOOD,
    { { SK_FIGHTING, 3 }, { SK_SHIELDS, 3 }, { SK_ARMOUR, 3 },
      { SK_THROWING, 1 }, { SK_WEAPON, 3 } },
} },
...
{ JOB_GLADIATOR, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_MERFOLK, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, },
    { "leather armour", "helmet", "throwing net q:10" },
    WCHOICE_GOOD,
...
{ JOB_HUNTER, {
    "Hu", "Hunter",
    5, 2, 5,
    { SP_HIGH_ELF, SP_HILL_ORC, SP_HALFLING, SP_KOBOLD, SP_OGRE, SP_CAVE_TROLL,
      SP_CENTAUR, },
...
{ JOB_MONK, {
    "Mo", "Monk",
    3, 2, 7,
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_CAVE_TROLL, SP_MOON_TROLL, SP_CENTAUR, SP_MERFOLK,
...
{ JOB_NECROMANCER, {
    "Ne", "Necromancer",
    0, 7, 5,
    { SP_DEEP_ELF, SP_DEEP_DWARF, SP_MOON_TROLL, SP_HILL_ORC, SP_DEMONSPAWN, SP_MUMMY,
      SP_VAMPIRE, },
...
{ JOB_SKALD, {
    ...
    { { SK_FIGHTING, 3 }, { SK_ARMOUR, 1 }, { SK_DODGING, 1 },
      { SK_SPELLCASTING, 3 }, { SK_CHARMS, 3 }, { SK_WEAPON, 3 }, },
} },

{ JOB_SUMMONER, {
    "Su", "Summoner",
    0, 7, 5,
    { SP_DEEP_ELF, SP_HILL_ORC, SP_VINE_STALKER, SP_MOON_TROLL, SP_MERFOLK, SP_TENGU,
      SP_VAMPIRE, },
...
{ JOB_WARPER, {
    "Wr", "Warper",
    3, 5, 4,
    { SP_HALFLING, SP_HIGH_ELF, SP_DEEP_DWARF, SP_SPRIGGAN, SP_CENTAUR, SP_SLUDGE_ELF,
      SP_BASE_DRACONIAN, },
    { "leather armour", "buckler", "book of Spatial Translocations", "scroll of blinking",
      "tomahawk ego:dispersal q:25" },
    WCHOICE_PLAIN,
...
{ JOB_WIZARD, {
    "Wz", "Wizard",
    -1, 10, 3,
    { SP_HIGH_ELF, SP_DEEP_ELF, SP_NAGA, SP_BASE_DRACONIAN, SP_OCTOPODE, SP_MOON_TROLL,
      SP_HUMAN, SP_MUMMY, },
