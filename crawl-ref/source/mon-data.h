...

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, {AT_PECK, AF_PLAIN, 16}, {AT_CLAW, AF_PLAIN, 16},
       AT_NO_ATK },
    19, 1480,
    2, 17, MST_ELEVENGU, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_POISON_STRONG, 26}, {AT_BITE, AF_ACID, 25}, {AT_BITE, AF_DRAIN_XP, 24}, AT_NO_ATK },
    15, 940,
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 160,
    3, 17, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
...
//'b'irds
{
    ...
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ACID | MR_RES_NEG | MR_RES_POISON,
