...
// fiends, etc. ('1')
{
    ...
    M_SEE_INVIS | M_GLOWS | M_FLIES,
    MR_RES_POISON | MR_RES_HELLFIRE | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD | MR_VUL_WATER,
...

{
    ...
    MR_RES_HELLFIRE | mrd(MR_RES_FIRE | MR_RES_POISON | MR_RES_COLD | MR_RES_ELEC, 3),
...
{ // not an actual monster, used by a spell
    ...
    mrd(MR_RES_COLD | MR_RES_ELEC | MR_RES_ACID | MR_RES_FIRE, 3) | MR_RES_HELLFIRE | MR_RES_STICKY_FLAME,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE | mrd(MR_RES_FIRE, 3),
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_TALL_TILE,
    mrd(MR_RES_ELEC | MR_RES_FIRE, 3) | MR_RES_POISON | MR_RES_HELLFIRE | MR_RES_COLD,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_FLIES | M_TALL_TILE,
    MR_RES_ELEC | MR_RES_POISON | MR_RES_HELLFIRE | mrd(MR_RES_FIRE, 3),
