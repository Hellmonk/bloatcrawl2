...
// demonspawn and oni ('6')
{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_ONI, MONS_ONI, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 180,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_GIAGGOSTUONO, 'D', ETC_GOLD, "THE GIAGGOSTUONO",
    M_UNIQUE | M_SEE_INVIS | M_GENDER_NEUTRAL | M_WARM_BLOOD,
    MR_RES_ELEC | MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
    18, MONS_DRAGON, MONS_GOLDEN_DRAGON, MH_NATURAL, 120,
    { {AT_BITE, AF_PLAIN, 69}, {AT_TRAMPLE, AF_TRAMPLE, 69}, AT_NO_ATK, AT_NO_ATK },
    31, 4200,
    69, 4, MST_GIAGGOSTUONO, CE_CLEAN, S_LOUD_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
    {TILEP_MONS_GIAGGOSTUONO}, TILE_ERROR
},
