...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    15, MONS_GIANT_CENTIPEDE, MONS_GIANT_CENTIPEDE, MH_NATURAL, -3,
    { {AT_STING, AF_POISON_NASTY, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 2000,
    15, 24, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT,
...

{
    ...
    18, 1170,
    20, 6, MST_IRON_DRAGON, CE_CLEAN, S_LOUD_ROAR,
...
// fiends, etc. ('1')
{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_RES_POISON | MR_RES_HELLFIRE | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD
        | MR_VUL_WATER,
...

{
    ...
    16, MONS_STORM_DRAGON, MONS_STORM_DRAGON, MH_NATURAL, 100,
...
// "e"lves
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 460,
    3, 9, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 340,
    0, 15, MST_DOWAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
