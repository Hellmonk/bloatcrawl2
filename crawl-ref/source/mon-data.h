...

{
    ...
    M_SEE_INVIS,
    MR_RES_POISON | MR_VUL_FIRE | M_CRASH_DOORS,
...

{
    ...
    M_CONFUSED,
    MR_RES_POISON,
    4, MONS_PLANT, MONS_THORN_LOTUS, MH_PLANT, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK},
    10, 200,
    4, 9, MST_THORN_LOTUS, CE_NOCORPSE, S_SILENT,
    I_ANIMAL, HT_WATER, 8, SWIM_ENERGY(16),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_PLANT,
    {TILEP_MONS_THORN_LOTUS}, TILE_ERROR
},
...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_BLOOD_SCENT | M_CRASH_DOORS,
...

{
    ...
    M_WARM_BLOOD | M_FLIES | M_CRASH_DOORS,
    MR_NO_FLAGS,
...
{ // dummy; spawns in a single vault.
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_DWARF, MONS_DEEP_DWARF, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 800,
    2, 12, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEEP_DWARF_SCION}, TILE_ERROR
},

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEEP_DWARF_ARTIFICER}, TILE_ERROR
},

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEEP_DWARF_NECROMANCER}, TILE_ERROR
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 800,
    2, 12, MST_BK_TROG, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEEP_DWARF_BERSERKER}, TILE_ERROR
},

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_NO_REGEN,
    MR_NO_FLAGS,
    12, MONS_DWARF, MONS_DEEP_DWARF, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 600,
    2, 12, MST_DEATH_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEEP_DWARF_DEATH_KNIGHT}, TILE_ERROR
},

{
    ...
    M_SPEAKS | M_NO_REGEN,
    MR_RES_COLD,
    16, MONS_DWARF, MONS_DEEP_DWARF, MH_UNDEAD, -8,
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 600,
    2, 10, MST_UNBORN_DEEP_DWARF, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_UNBORN_DEEP_DWARF}, TILE_ERROR
},
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    10, MONS_GIANT_CENTIPEDE, MONS_GIANT_CENTIPEDE, MH_NATURAL, -3,
    { {AT_STING, AF_POISON_NASTY, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 160,
    2, 14, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT,
    {TILEP_MONS_GIANT_CENTIPEDE}, TILE_CORPSE_GIANT_CENTIPEDE
},
...

{
    ...
    M_NO_SKELETON | M_SEE_INVIS | M_CRASH_DOORS,
...

{
    ...
    M_WARM_BLOOD | M_GLOWS | M_HERD | M_NO_GEN_DERIVED | M_GHOST_DEMON | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    M_NO_SKELETON | M_FLIES | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_GLOWS | M_FLIES | M_TALL_TILE,
...

{
    ...
    M_COLD_BLOOD | M_FAST_REGEN | M_CRASH_DOORS,
    MR_RES_POISON,
...

{
    ...
    M_COLD_BLOOD | M_FLIES | M_CRASH_DOORS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_UNBREATHING | M_CRASH_DOORS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_FLIES | M_CRASH_DOORS,
...

{
    ...
    M_SEE_INVIS | M_COLD_BLOOD | M_FLIES | M_CRASH_DOORS,
...

{
    ...
    M_SEE_INVIS | M_FLIES | M_CRASH_DOORS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_GLOWS | M_FLIES | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_BATTY | M_GLOWS | M_FLIES,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES | M_CRASH_DOORS,
    MR_NO_FLAGS,
    ...
    SIZE_BIG, MON_SHAPE_QUADRUPED_WINGED,
...
// Mutant beasts - variable traits
{
    ...
    M_NO_POLY_TO | M_HYBRID | M_NO_GEN_DERIVED | M_CRASH_DOORS,
    MR_NO_FLAGS,
    ...
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED,
    {TILEP_MONS_MUTANT_BEAST}, TILE_CORPSE_MUTANT_BEAST
},
...

{
    ...
    M_BATTY | M_NO_POLY_TO | M_CRASH_DOORS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...

{
    ...
    M_WARM_BLOOD | M_HERD | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, SWIM_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA,
    {TILEP_MONS_SALAMANDER_STORMCALLER}, TILE_ERROR
},
...

{
    ...
    M_GLOWS,
    MR_RES_POISON | MR_RES_DAMNATION | MR_VUL_COLD | MR_VUL_WATER,
...

{
    ...
    14, MONS_TZITZIMITL, MONS_TZITZIMITL, MH_DEMONIC, MAG_IMMUNE,
    { {AT_CLAW, AF_MIASMATA, 27}, {AT_BITE, AF_PAIN, 18},
      {AT_ENGULF, AF_DRAIN_XP, 14}, AT_NO_ATK },
    22, 1050,
...

{
    ...
    MR_RES_DAMNATION | mrd(MR_RES_POISON | MR_RES_COLD | MR_RES_ELEC, 3),
...

{
    ...
    M_INSUBSTANTIAL | M_MAINTAIN_RANGE | M_FLIES | M_NO_EXP_GAIN,
...
{ // not an actual monster, used by a spell
    ...
    M_INSUBSTANTIAL | M_GLOWS | M_NOT_DANGEROUS | M_NO_POLY_TO
        | M_PROJECTILE | M_FLIES,
    mrd(MR_RES_COLD | MR_RES_ELEC | MR_RES_ACID, 3) | MR_RES_DAMNATION
        | MR_RES_STICKY_FLAME,
...

{
    ...
    M_UNIQUE | M_COLD_BLOOD | M_FAST_REGEN | M_TALL_TILE | M_CRASH_DOORS,
    MR_RES_POISON,
...
// Elephants.
{
    ...
    M_WARM_BLOOD | M_UNIQUE | M_SPEAKS | M_FEMALE | M_CRASH_DOORS,
    MR_NO_FLAGS,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_TALL_TILE,
    mrd(MR_RES_ELEC, 3) | MR_RES_POISON | MR_RES_DAMNATION | MR_RES_COLD,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_FLIES | M_TALL_TILE,
    MR_RES_ELEC | MR_RES_POISON | MR_RES_DAMNATION,
