...
static const duration_def duration_data[] =
{
    ...
    { DUR_PHASE_SHIFT,
      ...
      { "You feel closer to the material plane.", 1 }}, 2},
    { DUR_QUAD_DAMAGE,
      BLUE, "Quad",
      "quad damage", "",
      "", D_EXPIRES,
    ...
    { DUR_BLADE_OF_DISASTER,
      ...
      "Your blade brings disaster.", D_NO_FLAGS,
    {{ "Your blade no longer brings disaster.", []() {
    you.duration[DUR_NO_MORE_DISASTER] = 30;}}
    }},
    { DUR_NO_MORE_DISASTER,
      WHITE, "-Disaster",
      "-disaster", "recovering from disaster",
      "You are recovering from disaster.", D_NO_FLAGS,
    {{ "You have recovered from your disaster." }}},
    { DUR_FLAYED,
      RED, "Flay",
      "flayed", "",
