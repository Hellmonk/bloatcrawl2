...
static const skill_type skill_display_order[] =
{
    ...
    SK_TITLE, SK_SPELLCASTING, SK_BLANK_LINE,   SK_CONJURATIONS, SK_HEXES, SK_CHARMS,       SK_SUMMONINGS,   SK_NECROMANCY,  SK_TRANSLOCATIONS, SK_TRANSMUTATIONS, SK_TIME,       SK_BLANK_LINE, SK_FIRE_MAGIC, SK_ICE_MAGIC, SK_AIR_MAGIC,   SK_EARTH_MAGIC,  SK_POISON_MAGIC, SK_LIGHT_MAGIC,    SK_DARKNESS_MAGIC, SK_COLUMN_BREAK,
};
