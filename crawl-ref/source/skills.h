...
{
    SK_TITLE, SK_FIGHTING,     SK_BLANK_LINE, SK_SHORT_BLADES, SK_LONG_BLADES, SK_AXES,   SK_MACES_FLAILS, SK_POLEARMS,   SK_STAVES,     SK_UNARMED_COMBAT, SK_BLANK_LINE,     SK_BOWS, SK_CROSSBOWS,  SK_THROWING,   SK_SLINGS,    SK_BLANK_LINE, SK_ARMOUR,      SK_DODGING,      SK_SHIELDS,    SK_BLANK_LINE,  SK_INVOCATIONS,    SK_EVOCATIONS, SK_STEALTH,    SK_COLUMN_BREAK,
    SK_TITLE, SK_SPELLCASTING, SK_BLANK_LINE, SK_CONJURATIONS, SK_HEXES,       SK_CHARMS, SK_SUMMONINGS,   SK_NECROMANCY, SK_BLANK_LINE, SK_TRANSLOCATIONS, SK_TRANSMUTATIONS, SK_TIME, SK_BLANK_LINE, SK_FIRE_MAGIC, SK_ICE_MAGIC, SK_AIR_MAGIC,  SK_EARTH_MAGIC, SK_POISON_MAGIC, SK_BLANK_LINE, SK_LIGHT_MAGIC, SK_DARKNESS_MAGIC, SK_BLANK_LINE, SK_BLANK_LINE, SK_COLUMN_BREAK,
};
