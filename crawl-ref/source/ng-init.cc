...
void initialise_branch_depths()
{
    ...
    branch_type enabled_s_branch = random_choose(BRANCH_SWAMP, BRANCH_SHOALS, BRANCH_SNAKE, BRANCH_SPIDER);

    for (branch_type disabled : {BRANCH_SWAMP, BRANCH_SHOALS, BRANCH_SNAKE, BRANCH_SPIDER})
    {
