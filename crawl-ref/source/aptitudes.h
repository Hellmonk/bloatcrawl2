...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_KOBOLD,          SK_CONJURATIONS,    3),
    ...
    APT(SP_FROGTAUR,           SK_LONG_BLADES,     1),
