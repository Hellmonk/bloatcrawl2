...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_HUMAN,           SK_WHIPS_FLAILS,    0),
    APT(SP_HUMAN,           SK_POLEARMS,        0),
    APT(SP_HUMAN,           SK_MACES_STAVES,    0),
    ...
    APT(SP_HIGH_ELF,        SK_WHIPS_FLAILS,   -2),
    APT(SP_HIGH_ELF,        SK_POLEARMS,       -2),
    APT(SP_HIGH_ELF,        SK_MACES_STAVES,    0),
    ...
    APT(SP_DEEP_ELF,        SK_WHIPS_FLAILS,   -3),
    APT(SP_DEEP_ELF,        SK_POLEARMS,       -3),
    APT(SP_DEEP_ELF,        SK_MACES_STAVES,    0),
    ...
    APT(SP_SLUDGE_ELF,      SK_WHIPS_FLAILS,   -2),
    APT(SP_SLUDGE_ELF,      SK_POLEARMS,       -2),
    APT(SP_SLUDGE_ELF,      SK_MACES_STAVES,    0),
    ...
    APT(SP_HALFLING,        SK_WHIPS_FLAILS,   -1),
    APT(SP_HALFLING,        SK_POLEARMS,       -1),
    APT(SP_HALFLING,        SK_MACES_STAVES,   -2),
    ...
    APT(SP_HALFLING,        SK_CONJURATIONS, UNUSABLE_SKILL),
    ...
    APT(SP_HILL_ORC,        SK_WHIPS_FLAILS,    1),
    APT(SP_HILL_ORC,        SK_POLEARMS,        1),
    APT(SP_HILL_ORC,        SK_MACES_STAVES,   -1),
    ...
    APT(SP_KOBOLD,          SK_SHORT_BLADES,    2),
    APT(SP_KOBOLD,          SK_LONG_BLADES,    -1),
    APT(SP_KOBOLD,          SK_AXES,           -1),
    APT(SP_KOBOLD,          SK_WHIPS_FLAILS,    0),
    APT(SP_KOBOLD,          SK_POLEARMS,       -1),
    APT(SP_KOBOLD,          SK_MACES_STAVES,   -1),
    APT(SP_KOBOLD,          SK_SLINGS,          4),
    ...
    APT(SP_MUMMY,           SK_WHIPS_FLAILS,   -2),
    APT(SP_MUMMY,           SK_POLEARMS,       -2),
    APT(SP_MUMMY,           SK_MACES_STAVES,   -2),
    ...
    APT(SP_NAGA,            SK_WHIPS_FLAILS,    0),
    APT(SP_NAGA,            SK_POLEARMS,        0),
    APT(SP_NAGA,            SK_MACES_STAVES,    0),
    ...
    APT(SP_OGRE,            SK_WHIPS_FLAILS,    0),
    APT(SP_OGRE,            SK_POLEARMS,        0),
    APT(SP_OGRE,            SK_MACES_STAVES,    2),
    ...
    APT(SP_TROLL,           SK_WHIPS_FLAILS,   -2),
    APT(SP_TROLL,           SK_POLEARMS,       -2),
    APT(SP_TROLL,           SK_MACES_STAVES,   -1),
    ...
    APT(SP_RED_DRACONIAN,   SK_WHIPS_FLAILS,    0),
    APT(SP_RED_DRACONIAN,   SK_POLEARMS,        0),
    APT(SP_RED_DRACONIAN,   SK_MACES_STAVES,    0),
    ...
    APT(SP_WHITE_DRACONIAN, SK_WHIPS_FLAILS,    0),
    APT(SP_WHITE_DRACONIAN, SK_POLEARMS,        0),
    APT(SP_WHITE_DRACONIAN, SK_MACES_STAVES,    0),
    ...
    APT(SP_GREEN_DRACONIAN, SK_WHIPS_FLAILS,    0),
    APT(SP_GREEN_DRACONIAN, SK_POLEARMS,        0),
    APT(SP_GREEN_DRACONIAN, SK_MACES_STAVES,    0),
    ...
    APT(SP_YELLOW_DRACONIAN,SK_WHIPS_FLAILS,    0),
    APT(SP_YELLOW_DRACONIAN,SK_POLEARMS,        0),
    APT(SP_YELLOW_DRACONIAN,SK_MACES_STAVES,    0),
    ...
    APT(SP_GREY_DRACONIAN,  SK_WHIPS_FLAILS,    0),
    APT(SP_GREY_DRACONIAN,  SK_POLEARMS,        0),
    APT(SP_GREY_DRACONIAN,  SK_MACES_STAVES,    0),
    ...
    APT(SP_BLACK_DRACONIAN, SK_WHIPS_FLAILS,    0),
    APT(SP_BLACK_DRACONIAN, SK_POLEARMS,        0),
    APT(SP_BLACK_DRACONIAN, SK_MACES_STAVES,    0),
    ...
    APT(SP_PURPLE_DRACONIAN,SK_WHIPS_FLAILS,    0),
    APT(SP_PURPLE_DRACONIAN,SK_POLEARMS,        0),
    APT(SP_PURPLE_DRACONIAN,SK_MACES_STAVES,    0),
    ...
    APT(SP_MOTTLED_DRACONIAN,SK_WHIPS_FLAILS,    0),
    APT(SP_MOTTLED_DRACONIAN,SK_POLEARMS,        0),
    APT(SP_MOTTLED_DRACONIAN,SK_MACES_STAVES,    0),
    ...
    APT(SP_PALE_DRACONIAN,  SK_WHIPS_FLAILS,    0),
    APT(SP_PALE_DRACONIAN,  SK_POLEARMS,        0),
    APT(SP_PALE_DRACONIAN,  SK_MACES_STAVES,    0),
    ...
    APT(SP_BASE_DRACONIAN,  SK_WHIPS_FLAILS,    0),
    APT(SP_BASE_DRACONIAN,  SK_POLEARMS,        0),
    APT(SP_BASE_DRACONIAN,  SK_MACES_STAVES,    0),
    ...
    APT(SP_CENTAUR,         SK_WHIPS_FLAILS,   -1),
    APT(SP_CENTAUR,         SK_POLEARMS,       -1),
    APT(SP_CENTAUR,         SK_MACES_STAVES,   -1),
    ...
    APT(SP_DEMIGOD,         SK_WHIPS_FLAILS,   -1),
    APT(SP_DEMIGOD,         SK_POLEARMS,       -1),
    APT(SP_DEMIGOD,         SK_MACES_STAVES,   -1),
    ...
    APT(SP_SPRIGGAN,        SK_WHIPS_FLAILS,   -2),
    APT(SP_SPRIGGAN,        SK_POLEARMS,       -3),
    APT(SP_SPRIGGAN,        SK_MACES_STAVES,   -3),
    ...
    APT(SP_MINOTAUR,        SK_WHIPS_FLAILS,    2),
    APT(SP_MINOTAUR,        SK_POLEARMS,        2),
    APT(SP_MINOTAUR,        SK_MACES_STAVES,    2),
    ...
    APT(SP_GARGOYLE,         SK_WHIPS_FLAILS,    0),
    APT(SP_GARGOYLE,         SK_POLEARMS,       -1),
    APT(SP_GARGOYLE,         SK_MACES_STAVES,    0),
    ...
    APT(SP_DEMONSPAWN,      SK_WHIPS_FLAILS,   -1),
    APT(SP_DEMONSPAWN,      SK_POLEARMS,       -1),
    APT(SP_DEMONSPAWN,      SK_MACES_STAVES,   -1),
    ...
    APT(SP_GHOUL,           SK_WHIPS_FLAILS,   -1),
    APT(SP_GHOUL,           SK_POLEARMS,       -1),
    APT(SP_GHOUL,           SK_MACES_STAVES,   -1),
    ...
    APT(SP_TENGU,           SK_WHIPS_FLAILS,    1),
    APT(SP_TENGU,           SK_POLEARMS,        1),
    APT(SP_TENGU,           SK_MACES_STAVES,    1),
    ...
    APT(SP_MERFOLK,         SK_AXES,            1),
    APT(SP_MERFOLK,         SK_WHIPS_FLAILS,   -2),
    APT(SP_MERFOLK,         SK_POLEARMS,        3),
    APT(SP_MERFOLK,         SK_MACES_STAVES,    1),
    ...
    APT(SP_VAMPIRE,         SK_WHIPS_FLAILS,   -2),
    APT(SP_VAMPIRE,         SK_POLEARMS,       -1),
    APT(SP_VAMPIRE,         SK_MACES_STAVES,   -2),
    ...
    APT(SP_DEEP_DWARF,      SK_WHIPS_FLAILS,    0),
    APT(SP_DEEP_DWARF,      SK_POLEARMS,       -1),
    APT(SP_DEEP_DWARF,      SK_MACES_STAVES,   -1),
    ...
    APT(SP_FELID,           SK_WHIPS_FLAILS,  UNUSABLE_SKILL),
    APT(SP_FELID,           SK_POLEARMS,      UNUSABLE_SKILL),
    APT(SP_FELID,           SK_MACES_STAVES,  UNUSABLE_SKILL),
    ...
    APT(SP_OCTOPODE,        SK_SHORT_BLADES,    1),
    APT(SP_OCTOPODE,        SK_LONG_BLADES,     1),
    APT(SP_OCTOPODE,        SK_AXES,            1),
    APT(SP_OCTOPODE,        SK_WHIPS_FLAILS,    1),
    APT(SP_OCTOPODE,        SK_POLEARMS,        1),
    APT(SP_OCTOPODE,        SK_MACES_STAVES,    1),
    APT(SP_OCTOPODE,        SK_SLINGS,          1),
    APT(SP_OCTOPODE,        SK_BOWS,            1),
    APT(SP_OCTOPODE,        SK_CROSSBOWS,       1),
    APT(SP_OCTOPODE,        SK_THROWING,        1),
    APT(SP_OCTOPODE,        SK_ARMOUR,        UNUSABLE_SKILL),
    APT(SP_OCTOPODE,        SK_DODGING,         1),
    APT(SP_OCTOPODE,        SK_STEALTH,         4),
#if TAG_MAJOR_VERSION == 34
    APT(SP_OCTOPODE,        SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_OCTOPODE,        SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
...
#endif
    APT(SP_OCTOPODE,        SK_HEXES,           1),
    APT(SP_OCTOPODE,        SK_CHARMS,          1),
    APT(SP_OCTOPODE,        SK_SUMMONINGS,      1),
    APT(SP_OCTOPODE,        SK_NECROMANCY,      1),
    APT(SP_OCTOPODE,        SK_TRANSLOCATIONS,  1),
    APT(SP_OCTOPODE,        SK_TRANSMUTATIONS,  1),
    APT(SP_OCTOPODE,        SK_FIRE_MAGIC,      1),
    APT(SP_OCTOPODE,        SK_ICE_MAGIC,       1),
    APT(SP_OCTOPODE,        SK_AIR_MAGIC,       1),
    APT(SP_OCTOPODE,        SK_EARTH_MAGIC,     1),
    ...
    APT(SP_DJINNI,          SK_WHIPS_FLAILS,    0),
    APT(SP_DJINNI,          SK_POLEARMS,        0),
    APT(SP_DJINNI,          SK_MACES_STAVES,    0),
    ...
    APT(SP_LAVA_ORC,        SK_WHIPS_FLAILS,    1),
    APT(SP_LAVA_ORC,        SK_POLEARMS,        1),
    APT(SP_LAVA_ORC,        SK_MACES_STAVES,   -1),
    ...
    APT(SP_FORMICID,        SK_WHIPS_FLAILS,    0),
    APT(SP_FORMICID,        SK_POLEARMS,        0),
    APT(SP_FORMICID,        SK_MACES_STAVES,    0),
    ...
    APT(SP_VINE_STALKER,    SK_WHIPS_FLAILS,   -1),
    APT(SP_VINE_STALKER,    SK_POLEARMS,       -1),
    APT(SP_VINE_STALKER,    SK_MACES_STAVES,   -1),
    ...
    APT(SP_BARACHI,             SK_WHIPS_FLAILS,    1),
    APT(SP_BARACHI,             SK_POLEARMS,        0),
    APT(SP_BARACHI,             SK_MACES_STAVES,    1),
...
#if TAG_MAJOR_VERSION == 34
    APT(SP_BARACHI,             SK_CONJURATIONS,  UNUSABLE_SKILL),
#endif
    ...
    APT(SP_GNOLL,           SK_WHIPS_FLAILS,    8),
    APT(SP_GNOLL,           SK_POLEARMS,        8),
    APT(SP_GNOLL,           SK_MACES_STAVES,    8),
	...
	// SP_SILENT_SPECTRE
	APT(SP_SILENT_SPECTRE,	SK_FIGHTING,	   -2),
	APT(SP_SILENT_SPECTRE,	SK_SHORT_BLADES,   -1),
	APT(SP_SILENT_SPECTRE,	SK_LONG_BLADES,	   -1),
	APT(SP_SILENT_SPECTRE,  SK_AXES,		   -1),
	APT(SP_SILENT_SPECTRE,  SK_WHIPS_FLAILS,   -1),
	APT(SP_SILENT_SPECTRE,  SK_POLEARMS,	   -1),
	APT(SP_SILENT_SPECTRE,  SK_MACES_STAVES,   -1),
	APT(SP_SILENT_SPECTRE,  SK_SLINGS,		   -1),
	APT(SP_SILENT_SPECTRE,  SK_BOWS,		   -2),
	APT(SP_SILENT_SPECTRE,  SK_CROSSBOWS,      -2),
	APT(SP_SILENT_SPECTRE,  SK_THROWING,       -1),
	APT(SP_SILENT_SPECTRE,  SK_ARMOUR,         -1),
	APT(SP_SILENT_SPECTRE,  SK_DODGING,         2),
	APT(SP_SILENT_SPECTRE,  SK_STEALTH,         3),
#if TAG_MAJOR_VERSION == 34
	APT(SP_SILENT_SPECTRE,  SK_STABBING,     UNUSABLE_SKILL),
#endif
	APT(SP_SILENT_SPECTRE,  SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
	APT(SP_SILENT_SPECTRE,  SK_TRAPS,        UNUSABLE_SKILL),
#endif
	APT(SP_SILENT_SPECTRE,  SK_UNARMED_COMBAT,  0),
	APT(SP_SILENT_SPECTRE,  SK_SPELLCASTING,    2),
#if TAG_MAJOR_VERSION == 34
	APT(SP_SILENT_SPECTRE,  SK_CONJURATIONS, UNUSABLE_SKILL),
#endif
	APT(SP_SILENT_SPECTRE,  SK_HEXES,		    1),
	APT(SP_SILENT_SPECTRE,  SK_CHARMS,		   -1),
	APT(SP_SILENT_SPECTRE,  SK_SUMMONINGS,	   -1),
	APT(SP_SILENT_SPECTRE,  SK_NECROMANCY,		1),
	APT(SP_SILENT_SPECTRE,  SK_TRANSLOCATIONS,	3),
	APT(SP_SILENT_SPECTRE,  SK_TRANSMUTATIONS,	3),
	APT(SP_SILENT_SPECTRE,  SK_FIRE_MAGIC,	    0),
	APT(SP_SILENT_SPECTRE,  SK_ICE_MAGIC,	    0),
	APT(SP_SILENT_SPECTRE,  SK_AIR_MAGIC,		2),
	APT(SP_SILENT_SPECTRE,  SK_EARTH_MAGIC,	   -1),
	APT(SP_SILENT_SPECTRE,  SK_POISON_MAGIC,   -1),
	APT(SP_SILENT_SPECTRE,  SK_INVOCATIONS,    -2),
	APT(SP_SILENT_SPECTRE,  SK_EVOCATIONS,      1),

	// SP_GOBLIN
	APT(SP_GOBLIN, SK_FIGHTING, 3),
	APT(SP_GOBLIN, SK_SHORT_BLADES, 3),
	APT(SP_GOBLIN, SK_LONG_BLADES, 3),
	APT(SP_GOBLIN, SK_AXES, 3),
	APT(SP_GOBLIN, SK_WHIPS_FLAILS, 3),
	APT(SP_GOBLIN, SK_POLEARMS, 3),
	APT(SP_GOBLIN, SK_MACES_STAVES, 3),
	APT(SP_GOBLIN, SK_SLINGS, 3),
	APT(SP_GOBLIN, SK_BOWS, 3),
	APT(SP_GOBLIN, SK_CROSSBOWS, 3),
	APT(SP_GOBLIN, SK_THROWING, 3),
	APT(SP_GOBLIN, SK_ARMOUR, 3),
	APT(SP_GOBLIN, SK_DODGING, 3),
	APT(SP_GOBLIN, SK_STEALTH, 4),
#if TAG_MAJOR_VERSION == 34
	APT(SP_GOBLIN, SK_STABBING,     UNUSABLE_SKILL),
#endif
	APT(SP_GOBLIN, SK_SHIELDS, 3),
#if TAG_MAJOR_VERSION == 34
	APT(SP_GOBLIN, SK_TRAPS,        UNUSABLE_SKILL),
#endif
	APT(SP_GOBLIN, SK_UNARMED_COMBAT, 3),
	APT(SP_GOBLIN, SK_SPELLCASTING, 2),
#if TAG_MAJOR_VERSION == 34
	APT(SP_GOBLIN, SK_CONJURATIONS, UNUSABLE_SKILL),
#endif
	APT(SP_GOBLIN, SK_HEXES, 3),
	APT(SP_GOBLIN, SK_CHARMS, 3),
	APT(SP_GOBLIN, SK_SUMMONINGS, 3),
	APT(SP_GOBLIN, SK_NECROMANCY, 3),
	APT(SP_GOBLIN, SK_TRANSLOCATIONS, 3),
	APT(SP_GOBLIN, SK_TRANSMUTATIONS, 3),
	APT(SP_GOBLIN, SK_FIRE_MAGIC, 3),
	APT(SP_GOBLIN, SK_ICE_MAGIC, 3),
	APT(SP_GOBLIN, SK_AIR_MAGIC, 3),
	APT(SP_GOBLIN, SK_EARTH_MAGIC, 3),
	APT(SP_GOBLIN, SK_POISON_MAGIC, 3),
	APT(SP_GOBLIN, SK_INVOCATIONS, 4),
	APT(SP_GOBLIN, SK_EVOCATIONS, 3),

	// SP_LIGNIFITE
	APT(SP_LIGNIFITE, SK_FIGHTING, 0),
	APT(SP_LIGNIFITE, SK_SHORT_BLADES, -1),
	APT(SP_LIGNIFITE, SK_LONG_BLADES, -2),
	APT(SP_LIGNIFITE, SK_AXES, -3),
	APT(SP_LIGNIFITE, SK_WHIPS_FLAILS, 1),
	APT(SP_LIGNIFITE, SK_POLEARMS, 0),
	APT(SP_LIGNIFITE, SK_MACES_STAVES, 1),
	APT(SP_LIGNIFITE, SK_SLINGS, -2),
	APT(SP_LIGNIFITE, SK_BOWS, -2),
	APT(SP_LIGNIFITE, SK_CROSSBOWS, -2),
	APT(SP_LIGNIFITE, SK_THROWING, -1),
	APT(SP_LIGNIFITE, SK_ARMOUR, -2),
	APT(SP_LIGNIFITE, SK_DODGING, -1),
	APT(SP_LIGNIFITE, SK_STEALTH, 0),
#if TAG_MAJOR_VERSION == 34
	APT(SP_LIGNIFITE, SK_STABBING, UNUSABLE_SKILL),
#endif
	APT(SP_LIGNIFITE, SK_SHIELDS, 0),
#if TAG_MAJOR_VERSION == 34
	APT(SP_LIGNIFITE, SK_TRAPS, UNUSABLE_SKILL),
#endif
	APT(SP_LIGNIFITE, SK_UNARMED_COMBAT, 0),
	APT(SP_LIGNIFITE, SK_SPELLCASTING, 0),
#if TAG_MAJOR_VERSION == 34
	APT(SP_LIGNIFITE, SK_CONJURATIONS, UNUSABLE_SKILL),
#endif
	APT(SP_LIGNIFITE, SK_HEXES, -1),
	APT(SP_LIGNIFITE, SK_CHARMS, -1),
	APT(SP_LIGNIFITE, SK_SUMMONINGS, 0),
	APT(SP_LIGNIFITE, SK_NECROMANCY, -2),
	APT(SP_LIGNIFITE, SK_TRANSLOCATIONS, -2),
	APT(SP_LIGNIFITE, SK_TRANSMUTATIONS, -2),
	APT(SP_LIGNIFITE, SK_FIRE_MAGIC, -2),
	APT(SP_LIGNIFITE, SK_ICE_MAGIC, -1),
	APT(SP_LIGNIFITE, SK_AIR_MAGIC, 0),
	APT(SP_LIGNIFITE, SK_EARTH_MAGIC, 1),
	APT(SP_LIGNIFITE, SK_POISON_MAGIC, 2),
	APT(SP_LIGNIFITE, SK_INVOCATIONS, 1),
	APT(SP_LIGNIFITE, SK_EVOCATIONS, -1)
};
