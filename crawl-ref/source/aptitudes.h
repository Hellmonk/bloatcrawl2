...
static const species_skill_aptitude species_skill_aptitudes[] =
{
	...
	// SP_SILENT_SPECTRE
	APT(SP_SILENT_SPECTRE,	SK_FIGHTING,	   -3),
	APT(SP_SILENT_SPECTRE,	SK_SHORT_BLADES,	0),
	APT(SP_SILENT_SPECTRE,	SK_LONG_BLADES,		0),
	APT(SP_SILENT_SPECTRE,  SK_AXES,			0),
	APT(SP_SILENT_SPECTRE,  SK_MACES_FLAILS,    0),
	APT(SP_SILENT_SPECTRE,  SK_POLEARMS,		0),
	APT(SP_SILENT_SPECTRE,  SK_STAVES,			0),
	APT(SP_SILENT_SPECTRE,  SK_SLINGS,		   -2),
	APT(SP_SILENT_SPECTRE,  SK_BOWS,		   -3),
	APT(SP_SILENT_SPECTRE,  SK_CROSSBOWS,      -3),
	APT(SP_SILENT_SPECTRE,  SK_THROWING,       -1),
	APT(SP_SILENT_SPECTRE,  SK_ARMOUR,         -2),
	APT(SP_SILENT_SPECTRE,  SK_DODGING,         3),
	APT(SP_SILENT_SPECTRE,  SK_STEALTH,         4),
#if TAG_MAJOR_VERSION == 34
	APT(SP_SILENT_SPECTRE,  SK_STABBING, UNUSABLE_SKILL),
#endif
	APT(SP_SILENT_SPECTRE,  SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
	APT(SP_SILENT_SPECTRE,  SK_TRAPS, UNUSABLE_SKILL),
#endif
	APT(SP_SILENT_SPECTRE,  SK_UNARMED_COMBAT,  0),
	APT(SP_SILENT_SPECTRE,  SK_SPELLCASTING,    3),
	APT(SP_SILENT_SPECTRE,  SK_CONJURATIONS,    0),
	...
	APT(SP_SILENT_SPECTRE,  SK_INVOCATIONS,    -3),
	...
	APT(SP_GOBLIN, SK_CONJURATIONS, 3),
