...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_LEPRECHAUN,        SK_ARMOUR,         -2),
    APT(SP_LEPRECHAUN,        SK_DODGING,         0),
    APT(SP_LEPRECHAUN,        SK_STEALTH,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_LEPRECHAUN,        SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_LEPRECHAUN,        SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_LEPRECHAUN,        SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_LEPRECHAUN,        SK_UNARMED_COMBAT,  0),
    APT(SP_LEPRECHAUN,        SK_SPELLCASTING,    0),
    APT(SP_LEPRECHAUN,        SK_CONJURATIONS,   -1),
    APT(SP_LEPRECHAUN,        SK_HEXES,          -1),
    APT(SP_LEPRECHAUN,        SK_CHARMS,          5),
    APT(SP_LEPRECHAUN,        SK_SUMMONINGS,     -1),
    APT(SP_LEPRECHAUN,        SK_NECROMANCY,     -1),
    APT(SP_LEPRECHAUN,        SK_TRANSLOCATIONS,  0),
    ...
    APT(SP_LEPRECHAUN,        SK_INVOCATIONS,    -2),
    APT(SP_LEPRECHAUN,        SK_EVOCATIONS,     -3),
