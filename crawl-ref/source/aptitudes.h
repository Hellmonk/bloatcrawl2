...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_GNOLL,           SK_LONG_BLADES,     4),
    APT(SP_GNOLL,           SK_AXES,            4),
    APT(SP_GNOLL,           SK_MACES_FLAILS,    4),
    APT(SP_GNOLL,           SK_POLEARMS,        4),
    APT(SP_GNOLL,           SK_STAVES,          4),
    APT(SP_GNOLL,           SK_SLINGS,          4),
    APT(SP_GNOLL,           SK_BOWS,            4),
    APT(SP_GNOLL,           SK_CROSSBOWS,       4),
    ...
    APT(SP_GNOLL,           SK_CONJURATIONS,    4),
    ...
    APT(SP_GNOLL,           SK_POISON_MAGIC,    4),
