...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_HALFLING,        SK_STAVES,        UNUSABLE_SKILL),
    APT(SP_HALFLING,        SK_SLINGS,        UNUSABLE_SKILL),
    ...
    APT(SP_FROGTAUR,           SK_CROSSBOWS,      -1),
...
#endif
    // SP_GNOLL
    APT(SP_GNOLL,           SK_FIGHTING,        6),
    APT(SP_GNOLL,           SK_SHORT_BLADES,    6),
    APT(SP_GNOLL,           SK_LONG_BLADES,     6),
    APT(SP_GNOLL,           SK_AXES,            6),
    APT(SP_GNOLL,           SK_MACES_FLAILS,    6),
    APT(SP_GNOLL,           SK_POLEARMS,        6),
    APT(SP_GNOLL,           SK_STAVES,          6),
    APT(SP_GNOLL,           SK_SLINGS,          6),
    APT(SP_GNOLL,           SK_BOWS,            6),
    APT(SP_GNOLL,           SK_CROSSBOWS,       6),
    APT(SP_GNOLL,           SK_THROWING,        6),
    APT(SP_GNOLL,           SK_ARMOUR,          6),
    APT(SP_GNOLL,           SK_DODGING,         6),
    APT(SP_GNOLL,           SK_STEALTH,         3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GNOLL,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_GNOLL,           SK_SHIELDS,         6),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GNOLL,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_GNOLL,           SK_UNARMED_COMBAT,  6),
