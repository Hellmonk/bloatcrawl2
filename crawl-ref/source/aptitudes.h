...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_OGRE,            SK_LONG_BLADES,    -2),
    APT(SP_OGRE,            SK_AXES,           -2),
    ...
    APT(SP_OGRE,            SK_HEXES,          -2),
    APT(SP_OGRE,            SK_CHARMS,         -1),
    APT(SP_OGRE,            SK_SUMMONINGS,     -2),
    APT(SP_OGRE,            SK_NECROMANCY,     -1),
    APT(SP_OGRE,            SK_TRANSLOCATIONS, -2),
    APT(SP_OGRE,            SK_TRANSMUTATIONS, -2),
    APT(SP_OGRE,            SK_FIRE_MAGIC,     -2),
    APT(SP_OGRE,            SK_ICE_MAGIC,      -2),
    APT(SP_OGRE,            SK_AIR_MAGIC,      -2),
    APT(SP_OGRE,            SK_EARTH_MAGIC,    -1),
    APT(SP_OGRE,            SK_POISON_MAGIC,   -2),
