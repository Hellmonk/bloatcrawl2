...
static const species_skill_aptitude species_skill_aptitudes[] =
{
	...
	APT(SP_SILENT_SPECTRE,	SK_SHORT_BLADES,	2),
	APT(SP_SILENT_SPECTRE,	SK_LONG_BLADES,		2),
	APT(SP_SILENT_SPECTRE,  SK_AXES,			2),
	APT(SP_SILENT_SPECTRE,  SK_MACES_FLAILS,    2),
	APT(SP_SILENT_SPECTRE,  SK_POLEARMS,		2),
	APT(SP_SILENT_SPECTRE,  SK_STAVES,			2),
