...
static short _get_stat_colour(stat_type stat)
{
    ...
    if (you.duration[DUR_DIVINE_STAMINA]
        || (you.duration[DUR_SQUAT] && (stat == STAT_STR || stat == STAT_INT)))
    {
...
const char *equip_slot_to_name(int equip)
{
    ...
    if (equip == EQ_BOOTS
        && (you.species == SP_CENTAUR || you.species == SP_NAGA || you.species == SP_SLITHERIER_NAGA))
    {
        return "Barding";
    }
    ...
    for (equipment_type eqslot : e_order)
    {
                 ...
                 && you.form == transformation::blade_hands)
        {
            ...
            str = string("  - Blade Hand") + (plural ? "s" : "");
                 ...
                 && (you.species == SP_NAGA || you.species == SP_CENTAUR || you.species == SP_SLITHERIER_NAGA))
        {
...
static vector<formatted_string> _get_overview_stats()
{
    ...
    if (you.species == SP_FELID
        // Shapeshifters can get an extra life when levelling up in Felid form!
        || (you.shapeshifter_species && (you.lives > 0 || you.deaths > 0)))
    {
        entry.textcolour(HUD_CAPTION_COLOUR);
        entry.cprintf("Lives:  ");
