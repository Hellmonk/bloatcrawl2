...
enum item_status_flag_type  // per item flags: ie. ident status, cursed status
{
    ...
    ISFLAG_UNUSED0           = 0x00000100,  // was ISFLAG_CURSED
...
enum mutation_type
{
    ...
    MUT_NO_HEALTH_REGENERATION,
    MUT_NO_MAGIC_REGENERATION,
    MUT_NO_STAMINA_REGENERATION,
    NUM_MUTATIONS,
